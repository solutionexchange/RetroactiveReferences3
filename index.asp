...
<head>
	...
	<script id="template-processing" type="text/x-handlebars-template" data-container="#processing" data-action="append">
		<div class="alert alert-warning">
			{{message}}
		</div>
	</script>
	
	<script id="template-processing-success" type="text/x-handlebars-template" data-container="#processing" data-action="append">
